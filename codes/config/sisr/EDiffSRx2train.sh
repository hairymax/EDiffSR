#!/bin/bash
#SBATCH --job-name=EDiffSRx2        # create a short name for your job
...
python -m torch.distributed.launch \
    --nproc_per_node=4 \
    --master_port=13122 \
    --use_env train.py -opt options/train/setting2x3m.yml \
    --launcher pytorch
    # --use_env train.py -opt options/train/setting2x.yml \